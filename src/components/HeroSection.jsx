          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <Button
                ...
                className="bg-[#8B5CF6] hover:bg-[#A855F7] text-white px-8 py-6 text-lg transition-all duration-300 transform hover:scale-105"
              >
                Lihat Proyek
              ...
              <Button
                ...
                variant="outline"
                className="border-[#8B5CF6] text-[#8B5CF6] hover:bg-[#8B5CF6] hover:text-white px-8 py-6 text-lg transition-all duration-300"
              >
                Hubungi saya
              </Button>
            </div>
